...
import { useChangeSubAdminPasswordMutation, useUpdateSubAdminMutation } from '../subAdminsApiSlice';
import FeedbackAlert from '../../../components/FeedbackAlert';

const SubAdminSetting = ({subAdmin}) => {
	const [changeSubAdminPassword] = useChangeSubAdminPasswordMutation();
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			formData.append('gender', subAdmin.gender);
			formData.append('contact', contact);
			formData.append('nationality', nationality);
			formData.append('dob', dob);
			formData.append('department_id', subAdmin.department_id);
	...
	const handlePasswordChange = async (e) => {
		...
		try {
			...
			let x = await changeSubAdminPassword(passDetails);
			console.log(x);
			if (x.error) {
