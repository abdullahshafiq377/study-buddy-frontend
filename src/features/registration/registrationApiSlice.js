    ...
    endpoints: (builder) => ({
        getUnregisteredCourses: builder.query({
            ...
            transformResponse: (responseData) => {
                return registrationsAdapter.setAll(initialState, responseData);
            },
            providesTags: (result, error, arg) => [
                {type: 'UnregisteredCourse', id: 'LIST'},
                ...result.ids.map((id) => ({type: 'UnregisteredCourse', id})),
            ],
        }),
        getRegisteredCourses: builder.query({
            ...
            providesTags: (result, error, arg) => [
                {type: 'RegisteredCourse', id: 'LIST'},
                ...result.ids.map((id) => ({type: 'RegisteredCourse', id})),
            ],
        }),
        registerCourse: builder.mutation({
            ...
            invalidatesTags: [{type: 'RegisteredCourse', id: 'LIST'}, {type: 'UnregisteredCourse', id: 'LIST'}],
        }),
        unregisterCourse: builder.mutation({
            ...
            invalidatesTags: (result, error, arg) => [
                {type: 'RegisteredCourse', id: 'LIST'}, {type: 'UnregisteredCourse', id: 'LIST'}
            ],
        }),
