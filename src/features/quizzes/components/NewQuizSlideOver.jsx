...
import { useAddNewQuizMutation } from '../quizApiSlice';

export default function NewQuizSlideOver ({open, setOpen}) {
	const userId = useSelector(selectCurrentUserId);
	
	const {data: sectionData, isSuccess: isSuccessSection} = useGetSectionsByInstructorQuery(userId);
	const [addNewQuiz] = useAddNewQuizMutation();
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			quiz.append('sectionId', section.id);
			quiz.append('startTime', startTime);
			quiz.append('startDate', startDate);
			quiz.append('endTime', endTime);
			quiz.append('endDate', endDate);
			quiz.append('instructions', instructions);
			quiz.append('totalMarks', totalMarks);
			file ? quiz.append('file', file, file?.name) : quiz.append('file', null);
