...
export default function UnassignedStudentsTable ({section, unassignedStudents, refetchAssigned, refetchUnassigned}) {
	const [assignSection] = useAssignSectionMutation();
	const people = unassignedStudents;
	...
	const handleUnAssign = async () => {
		try {
			...
			await assignSection(sectionDetails)
				.unwrap();
			setSelectedPeople([]);
			refetchAssigned();
			refetchUnassigned();
							...
							<table className="min-w-full table-fixed divide-y divide-gray-300">
								...
								<tbody className="divide-y divide-gray-200 bg-white">
								{
									...
									(<tr>
										...
										<td className="text-sm font-medium text-red-600">No unassigned students
											available
										</td>
									</tr>)
								}
