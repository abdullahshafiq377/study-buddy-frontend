...
const InstructorLearningResourceTable = ({sectionId}) => {
		...
		content = (
			<>
				<table className="min-w-full divide-y divide-gray-300">
					...
					{ids.map(id => {
						return <InstructorLearningResourceTableRow learningResource={entities[id]}/>;
					})}
					</tbody>
				</table>
			</>
...
export default InstructorLearningResourceTable;
