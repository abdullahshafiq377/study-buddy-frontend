...
import {selectDepartmentById, useDeleteDepartmentMutation, useUpdateDepartmentMutation,} from '../departmentsApiSlice';
...
export default function EditDepartmentForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await updateDepartment(updatedDepartment).unwrap();
            setTitle('');
            setDescription('');
