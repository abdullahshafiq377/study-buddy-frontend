...
import { selectAllCourses, useAddNewCourseMutation } from '../coursesApiSlice';
...
export default function AddCourseForm () {
	...
	const handleSubmit = async (e) => {
		try {
			...
			const alreadyExists = courses.some(obj => {
				return obj.course_code === courseCode; //todo
			});
			console.log(alreadyExists);
			
			if (alreadyExists) {
				setErrorMessage('ERROR: Course already exists please use a different course code.');
