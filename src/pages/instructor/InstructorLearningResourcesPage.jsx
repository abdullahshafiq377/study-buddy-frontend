...
import NewLearningResourceSlideOver from '../../features/learning-resource/components/NewLearningResourceSlideOver';

const InstructorLearningResourcesPage = () => {
	const [openNewLearningResourceSlideOver, setOpenNewLearningResourceSlideOver] = useState(false);
	return (
		<>
			<div className="px-4 sm:px-6 lg:px-8">
				<div className="sm:flex sm:items-center">
					...
					<div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
						<button
							onClick={() => setOpenNewLearningResourceSlideOver(!openNewLearningResourceSlideOver)}
			...
			<NewLearningResourceSlideOver open={openNewLearningResourceSlideOver}
			                              setOpen={setOpenNewLearningResourceSlideOver}/>
		</>
	);
};

export default InstructorLearningResourcesPage;
