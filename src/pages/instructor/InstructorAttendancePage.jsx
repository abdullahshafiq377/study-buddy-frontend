...
import NewAttendanceSlideOver from '../../features/attendance/components/NewAttendanceSlideOver';

const InstructorAttendancePage = () => {
	const [openNewAttendanceSlideOver, setOpenNewAttendanceSlideOver] = useState(false);
	return (
		<>
			<div className="px-4 sm:px-6 lg:px-8">
				<div className="sm:flex sm:items-center">
					...
					<div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
						<button
							onClick={() => setOpenNewAttendanceSlideOver(!openNewAttendanceSlideOver)}
			...
			<NewAttendanceSlideOver open={openNewAttendanceSlideOver} setOpen={setOpenNewAttendanceSlideOver}/>
		</>
	);
};
